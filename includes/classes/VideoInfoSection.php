...
class VideoInfoSection {
    ...
    private function createSecondaryInfo() {
        ...
        return "<div class='secondaryInfo'>
                    ...
                    <br/>
                    <br/>
                    It is very rare to hear a money manager recommend holding cash.  Ray Dalio, who started the worlds largest hedge fund Bridgewater Associates, often preaches the dangers of holding cash.  However, this week it was refreshing to hear Dan Niles, the founder of the Santori Fund, state on CNBC that he believes it is important to hold cash right now.  That is a rare statement coming from a fund manager.  I believe that we are at a point in the cycle that “Cash is King” again.  Sure, inflation might be running at ~6% annually right now, which is not good.  But, if you were invested in the NASDAQ on Friday, you lost around 2% of your money….   in ONE DAY!   Many of us have experienced some great gains in 2021 with the DJIA up 12.98%, the NASDAQ up 17.05% and the S&P up 20.83%, so what is the danger of taking money off the table while waiting for better opportunities?  For this reason, I am currently in 100% in cash. 
                    <br/>
                    <br/>
                    WHERE ARE THE OPPORTUNITIES: 
                    <br/> 
                    <br/>
                    If you consider yourself a trader, then there are some great opportunities right now.  I look for quality companies with very strong earnings and balance sheets.  I find many of these opportunities in the financial sector.  Specifically in the large money center banks and insurance companies.  When the market drags these stocks down 3-4% I step in and buy a basket.  When they recover a bit, I sell.  Even if it is for a 1-2% gain.  This strategy worked great for me this week and I was able to side-step the volatility and make money in a down market.
                    <br/>
                    <br/>
                    ...
                    <br/>
                    <br/>
                    (The app I use is called “StocksTracker.”  It is a free app that can be downloaded from the app store.  It is priceless to me.  No pricey Boomberg Terminals here!).
                    <br/>
                    <br/>
                    Good luck!!
                    <br/>
